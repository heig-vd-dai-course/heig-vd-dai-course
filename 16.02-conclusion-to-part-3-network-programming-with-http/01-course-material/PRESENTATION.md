...
title: 'HEIG-VD DAI - Conclusion to part 3: Network programming with HTTP'
description: 'Conclusion to part 3: Network programming with HTTP for the DAI course at HEIG-VD, Switzerland'
header: '[**Conclusion to part 3: Network programming with HTTP**](https://github.com/heig-vd-dai-course/heig-vd-dai-course/tree/main/16.02-conclusion-to-part-3-network-programming-with-http)'
